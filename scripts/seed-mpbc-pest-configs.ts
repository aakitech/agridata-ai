      ...
      fields: [
        {
          ...
          required: true,
          displayOrder: 1,
          options: ["1_10", "10_100", "100_1000", "1000_plus"],
        },
        {
      ...
      severityRules: [
        {
          ...
          conditionExpression: { field: "event_scale", operator: "=", value: "1000_plus" },
        },
        {
          ruleOrder: 2,
          severity: "WARNING",
          conditionKind: "CATEGORICAL",
          conditionExpression: { field: "event_scale", operator: "=", value: "100_1000" },
        },
        {
          ruleOrder: 99,
          severity: "NORMAL",
