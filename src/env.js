...
export const env = createEnv({
  ...
  server: {
    ...
    WEATHER_ENRICHMENT_ENABLED: z.coerce.boolean().default(true),
    WEATHER_INLINE_ENRICHMENT_ENABLED: z.coerce.boolean().default(true),
    WEATHER_BACKFILL_ENABLED: z.coerce.boolean().default(true),
    ...
    WEATHER_INLINE_ENRICHMENT_TIMEOUT_MS: z.coerce.number().int().min(0).max(5000).default(800),
  ...
  runtimeEnv: {
    ...
    WEATHER_ENRICHMENT_ENABLED: process.env.WEATHER_ENRICHMENT_ENABLED,
    WEATHER_INLINE_ENRICHMENT_ENABLED: process.env.WEATHER_INLINE_ENRICHMENT_ENABLED,
    WEATHER_BACKFILL_ENABLED: process.env.WEATHER_BACKFILL_ENABLED,
    ...
    WEATHER_INLINE_ENRICHMENT_TIMEOUT_MS: process.env.WEATHER_INLINE_ENRICHMENT_TIMEOUT_MS,
